...
import {
    ...
    // Backend
    SiNodedotjs, SiExpress, SiFastapi, SiPrisma, SiDrizzle, SiFlask, SiDjango,
    // Data
    SiPostgresql, SiMongodb, SiSupabase,
    // AI / LLM
    SiOpenai, SiAnthropic, SiGooglegemini, SiLangchain, SiOllama, SiHuggingface, SiPytorch, SiScikitlearn,
    // Voice
    SiDeepgram,
    // DevOps
...
const skillIconMap: Record<string, { icon: IconComponent; color: string | null }> = {
    ...
    Azure: { icon: SiAmazonwebservices, color: '#0078D4' },

    // ML
    'Scikit-learn': { icon: SiScikitlearn, color: '#F7931E' },
    XGBoost: { icon: SiPython, color: '#EE4C2C' },

    // Additional Backend
    Flask: { icon: SiFlask, color: null },
    Django: { icon: SiDjango, color: '#092E20' },

    // LangSmith (no dedicated icon — reuse LangChain)
    LangSmith: { icon: SiLangchain, color: '#3DA374' },

    // LlamaIndex (no dedicated icon — reuse LangChain color family)
    LlamaIndex: { icon: SiLangchain, color: '#FFA500' },

    // Pydantic (no dedicated icon — reuse Python)
    Pydantic: { icon: SiPython, color: '#E92063' },

    // MLflow (no dedicated icon — reuse Git)
    MLflow: { icon: SiGit, color: '#0194E2' },

    // DVC (no dedicated icon — reuse Git)
    DVC: { icon: SiGit, color: '#945DD6' },
...
const skillCategories = [
    ...
    {
        title: 'AI Frameworks',
        skills: ['LangChain', 'LangGraph', 'LangSmith', 'LlamaIndex', 'OpenAI', 'Claude', 'Gemini', 'Groq', 'DeepSeek', 'Ollama', 'Hugging Face', 'PyTorch', 'Pydantic'],
    },
    {
        title: 'ML / Deep Learning',
        skills: ['PyTorch', 'XGBoost', 'Scikit-learn'],
    },
    {
        title: 'Backend & APIs',
        skills: ['FastAPI', 'Flask', 'Django', 'Node.js'],
    },
    {
        title: 'Databases & Vector',
        skills: ['PostgreSQL', 'ChromaDB', 'Qdrant', 'MongoDB'],
    },
    {
        title: 'MLOps & DevOps',
        skills: ['Docker', 'Git', 'Linux', 'DVC', 'MLflow', 'Cloudflare', 'Vercel'],
    },
    {
        title: 'Soft Skills',
        skills: ['Client Communication', 'Team Leadership', 'POC Pitching', 'Project Management', 'Technical Writing', 'Stakeholder Management'],
    },
];
        ...
        >
            <Container>
                <h2 className="font-mono text-[2.5vw] md:text-base uppercase tracking-widest text-fg-secondary mb-[8vw] md:mb-10">
                    <span className="text-fg-primary/30">05 /</span> Technical Expertise
                </h2>

                <p className="text-[4vw] md:text-xl text-fg-secondary leading-relaxed mb-[12vw] md:mb-16 max-w-2xl">
                    Production-tested stack. Every tool here has shipped real AI — not tutorials, not side projects. Grouped by layer.
                </p>
