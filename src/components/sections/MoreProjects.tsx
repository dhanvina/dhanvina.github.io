    ...
    return (
        <section id="more-projects" className="inverted bg-bg-primary text-fg-primary pt-[16vw] pb-[20vw] md:pt-24 md:pb-24 relative">
            <Container>
                ...
                >
                    <span className="text-fg-primary/30">04 /</span> More from GitHub
                </motion.h2>
                <motion.p
                    ...
                    <AnimatePresence mode="popLayout">
                        {visible.map((p, i) => (
                            <motion.button
                                ...
                                className="group relative flex flex-col text-left border border-border-primary rounded-2xl p-[5vw] md:p-6 bg-[#bfbfbf] hover:bg-[#b0b0b0] transition-colors cursor-pointer"
                            >
