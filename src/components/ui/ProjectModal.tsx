                                ...
                                <div className="px-[6vw] md:px-8 py-[6vw] md:py-8">
                                    ...
                                    <div className="flex flex-wrap gap-[3vw] md:gap-3 pt-[4vw] md:pt-6 border-t border-border-primary/60">
                                        {project.liveUrl ? (
                                            ...
                                            <span className="inline-flex items-center gap-[2vw] md:gap-2 px-[5vw] md:px-5 py-[3vw] md:py-2.5 rounded-full border border-border-primary font-mono text-[2.8vw] md:text-xs uppercase tracking-widest text-fg-secondary">
                                                <span className="w-[2vw] h-[2vw] md:w-2 md:h-2 rounded-full bg-amber-400 animate-pulse shrink-0" />
                                                In Development
                                            </span>
                                        )}
                                        <a
