...
# Dhanvina - Portfolio Content

## Hero Section
- **Name:** Dhanvina
- **Tagline:** AI Engineer — building production-ready ML systems, inference pipelines, and MLOps.
- **Links & Socials:** GitHub, LinkedIn, Resume, Email
- **Aesthetic:** Keeps the original radial theme, subtle paint-trail cursor, and animated hero interactions from the theme you liked.

---

## 01 / Experience
**F9 CYBRISK Tech Private Limited – Bangalore**
### AI Engineer (Designated: Chief AI Officer) 
**September 2024 – Present**
- Built a production deepfake detection system processing media files; achieved 91.2% F1-score (≈8% improvement over EfficientNet baseline) using a custom CNN architecture and reduced false positives from 15% → 4.3%.
- Engineered a phishing-URL detection pipeline handling daily requests with 94.2% precision using an XGBoost ensemble; automation saved SOC analysts ~15 hours/week.
- Architected an end-to-end MLOps pipeline (DVC for dataset versioning, MLflow for experiments) reducing deployment time from 2 weeks → 3 days for models and pipelines (150GB+ data).
- Optimized inference latency for the deepfake detector from ~2.8s → 780ms via INT8 quantization and serving optimizations; system maintains >99.7% uptime.
- Led client-facing POCs for 4 cybersecurity products; scoped, built MVPs and presented to C-level, with 3/4 converting to production.
...
- **Contact Methods:** 
  ...
  - Socials: [GitHub](https://github.com/dhanvina), [LinkedIn](https://www.linkedin.com/in/ndhanvina/)
- **Copyright:** © 2026 Dhanvina
